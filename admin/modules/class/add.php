      ...
      <fieldset>
        <legend>New Grade level</legend>
          ...
          <div class="form-group">
                <div class="col-md-8">
                  <label class="col-md-4 control-label" for="coursename">Grade level</label>
...
<!--
                ...
                <div class="col-md-8">
                  ...
                  <div class="col-md-8">-->
                     <input class="form-control input-sm" id="level" name="level" placeholder="Course Level" type="hidden" value="">
            <!--      </div>
                </div>
              </div>
               <div class="form-group">
...
-->
        ...
        <!-- <div class="form-group">
                <div class="col-md-8">
                  ...
                  <div class="col-md-8">-->
                        ...
                        foreach ($cur as $Department) {
                          echo ' <input type="hidden" class="form-control input-sm" name="dept" id="dept" value="'. $Department->DEPARTMENT_ID.'">';
                        }
         ...
         <div class="form-group">
                <div class="col-md-8">
                  <label class="col-md-4 control-label" for="savecourse"></label>
