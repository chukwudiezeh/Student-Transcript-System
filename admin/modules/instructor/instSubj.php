...
<form class="form-horizontal span4" action="controller.php?action=delsubj" method="POST">
	<div class="panel panel-primary">
	  <div class="panel-heading">
	    <h3 class="panel-title"><span class="glyphicon glyphicon-user"></span> Lecturer's Subject </h3>
	  </div>
			    ...
			    <table id="example" class="display" cellspacing="0" width="100%">
				  ...
				  <thead>
				  	<tr>
				  		<tr>
				  		<th width="10">No</th>	
				  		<th  width="20%" class="bottom"> <input type="checkbox" name="chkall" id="chkall" onclick="return checkall('selector[]');">Course Code</th>
				  ...
				  <tbody>
				  	<?php
						...
						$mydb->setQuery("SELECT * 
								FROM  `subject` s,  `level` l  ,class cl
