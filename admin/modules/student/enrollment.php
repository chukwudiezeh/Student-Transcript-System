					   ...
					   <div class="row">
			            <div class="col-6 col-sm-6 col-lg-8">
			             <div class="form-group" id="idno">
				            <div class="col-md-8">
				              <label class="col-md-6 control-label" for="idno">ID Number: </label>
				              <div class="col-md-6">
				          ...
				          <div class="form-group" id="idno">
				            <div class="col-md-8">
				              ...
				              <div class="col-md-6">
				                <input class="form-control input-sm" readonly placeholder="Fullname" type="text" value="<?php echo (isset($cur)) ? $cur->LNAME.', '.$cur->FNAME.' '.$cur->MNAME : 'Fullname' ;?>">
								</div>	  
			             ...
			             <div class="form-group">
				            <div class="col-md-8">
				              <label class="col-md-6 control-label" for="course">Year and Section :</label>
