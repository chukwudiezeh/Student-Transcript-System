...
<span id="printout">
	<table class="" style="width:100%;" border="0">
		...
		<tr>
			<td width="45%" class="top"><h5>NAME: <?php echo $object->LNAME . ' '.$object->FNAME.' '.$object->MNAME; ?></h5>
			</td>
		...
		<tr>
			<td align="right"><h5>MATRIC NO.: <?php echo $object->MATRICNO; ?></h5>
			</td>
			<td width="45%"><h5>SEX: <?php echo $object->SEX; ?></h5>
			</td>
		
		</tr>
		<tr>
			<td width="45%" ><h5>SCHOOL: <?php echo bringschool($object->SCHOOL);  ?></h5>
			</td>
			<td align="right"><h5>DEPARTMENT: <?php echo bringdepartment($object->DEPARTMENT); ?></h5>
			</td>
	...
	<table  style="width:100%;" border="0">
		...
		<tr>
			<?php 
				/*$mydb->setQuery("SELECT `TRANS_PROG` FROM `transapplydetails` WHERE IDNO=".$_GET['studentId']);
				$exer=$mydb->executeQuery();
				if ($exer){
					if($rowcount=$mydb->num_rows($exer)>0){
						while ($row=$mydb->fetch_array($exer)) {
							if($row['TRANS_PROG']='ND'){
								echo '<td width="50%" class="top"><h5>PROGRAMME TYPE : ORDINARY NATIONAL DIPLOMA</h5></td>';
							}else{
								echo '<td width="50%" class="top"><h5>PROGRAMME TYPE: HIGHER NATIONAL DIPLOMA</h5></td>';
							}
						}
					}
				}*/
			...
			?>
			<td class="top" width="50%"><h5>PROGRAMME TYPE: ORDINARY NATIONAL DIPLOMA</h5></td>
	...
	?>
			<td><h5>AWARD : <?php echo bringprogramme($object->PROGRAMME);?> </h5>
			</td>
		<?php
}
		?>
